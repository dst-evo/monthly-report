...
# ----------------------------------------------------------- #
hv_total = [499634, 390405, 430625, 386275, 413301, 409882, 388122, 460498]
hv_bph_avg_b = [463, 471, 511, 470, 494, 419, 373, 461]
hv_bph_avg_a = [564, 508, 508, 504, 501, 477, 523, 512]
hv_bph_avg_c = [473, 440, 490, 485, 491, 417, 428, 447]
hv_bph_avg_d = [490, 447, 522, 541, 502, 457, 472, 449]
hv_bph_avg_cmc_b = [598, 616, 621, 604, 608, 548, 499, 587]
hv_bph_avg_cmc_a = [744, 731, 713, 709, 682, 641, 706, 669]
hv_bph_avg_cmc_c = [670, 664, 632, 634, 636, 570, 678, 607]
hv_bph_avg_cmc_d = [663, 681, 685, 706, 651, 622, 663, 615]
hv_bbm_b = [0.0544, 0.0387, 0.0455, 0.0488, 0.0477, 0.055, 0.0510, 0.047]
hv_bbm_a = [0.0282, 0.0276, 0.0342, 0.0327, 0.0346, 0.0407, 0.0277, 0.0225]
hv_bbm_c = [0.034, 0.0395, 0.0355, 0.0354, 0.0341, 0.0346, 0.0208, 0.0226]
hv_bbm_d = [0.0261, 0.027, 0.0218, 0.0203, 0.0265, 0.0255, 0.0224, 0.0314]
hv_avg_avail_b = [0.873, 0.911, 0.863, 0.865, 0.877, 0.849, 0.8610, 0.881]
hv_avg_avail_a = [0.915, 0.925, 0.904, 0.883, 0.879, 0.867, 0.9110, 0.92]
hv_avg_avail_c = [0.886, 0.898, 0.878, 0.878, 0.893, 0.888, 0.9150, 0.898]
hv_avg_avail_d = [0.92, 0.918, 0.913, 0.934, 0.907, 0.905, 0.9270, 0.889]
# ----------------------------------------------------------- #
